      ...
      <div id="sidebar-menu">
        <ul class="sidebar-links" id="simple-bar">
          ...
          <li class="sidebar-list">
            ...
            <ul class="sidebar-submenu">
              <li><a href="{{ route('foods.index') }}">chart List</a></li>
              <li><a href="{{ route('dietcharts.create') }}">Add Chart</a></li>
              <li><a href="{{ route('dietchart.trashed') }}">Trashed</a></li>
            </ul>
          </li>
          <li class="sidebar-list">
            <a class="sidebar-link sidebar-title" href="#"><i data-feather="clipboard"></i><span>Food</span></a>
            <ul class="sidebar-submenu">
              <li><a href="{{ route('foods.index') }}">Food List</a></li>
              <li><a href="{{ route('foods.create') }}">Add Food</a></li>
              <li><a href="{{ route('food.trashed') }}">Trashed</a></li>
            </ul>
          </li>
        </ul>
      </div>
