                  ...
                  <div class="row">
                    <div class="col">
                      <div class="mb-3">
                        ...
                        <input class="form-control input-air-primary" id="weight" type="text" placeholder="56 KG" name="weight">
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col">
                      <div class="mb-3">
                        ...
                        <input class="form-control input-air-primary" id="goal_weight" type="text" placeholder="60 KG" name="goal_weight">
                      </div>
                    </div>
                  </div>
                  <div class="row">
