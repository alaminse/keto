      ...
      <div class="row m-0">
        <div class="col-12 p-0">
          <div class="login-card">
            <div>
              <div><a class="logo" href="index.html"><img class="img-fluid for-light" src="{{ asset("public/backend/assets/images/logo/login.png") }}" alt="looginpage"><img class="img-fluid for-dark" src="{{ asset("public/backend/assets/images/logo/logo_dark.png") }}" alt="looginpage"></a></div>
              <main>
                @yield('content')
              </main>
            </div>
